...
DATABASES = {
    'default': {
        ...
        'ENGINE': 'django.contrib.gis.db.backends.postgis', # extension postgis
        'NAME': config('DB_NAME'),
        'USER': config('DB_USER'),
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'foodOnline Marketplace <foodonlinea@gmail.com>'

GOOGLE_API_KEY = 'AIzaSyAYyszoVSXQj2CIDD0FgSlggC97QBEhW2s  '
